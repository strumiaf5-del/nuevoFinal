...
(function (global) {
  ...
  class Widget {
    ...
    _onKeydown(e) {
      ...
      const nextLog = Math.max(0, Math.min(range, currentLog + delta));
    ...
    destroy() {
      ...
      if (this.canvas) {
        ...
        if (this._keydown) this.canvas.removeEventListener('keydown', this._keydown);
      }
      this._mouseMove = this._mouseLeave = this._click = this._keydown = null;
      this.canvas = null;
      this.ctx = null;
    }
